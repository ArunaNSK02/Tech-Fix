<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="TechFix_Client_Application.Login" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>TechFix Shop Login</title>
...
<body>
    <div class="container">
        ...
        <form id="loginform" runat="server">
            ...
            <asp:Button ID="btnSubmit" runat="server" Text="LOG IN" CssClass="custom-btn" OnClick="btnSubmit_Click"/>
        </form>
