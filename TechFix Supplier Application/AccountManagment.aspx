<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountManagment.aspx.cs" Inherits="TechFix_Supplier_Application.AccountManagment" %>
...
<body>
    ...
    <div class="container">
        <div class="input-group" style="grid-column: 1/2">
            <span class="userform-label">Company Name: </span>
